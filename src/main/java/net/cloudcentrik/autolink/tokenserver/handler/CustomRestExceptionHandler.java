package net.cloudcentrik.autolink.tokenserver.handler;
...
import net.cloudcentrik.autolink.tokenserver.model.ApiError;
...
public class CustomRestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleTypeMismatch(final TypeMismatchException ex, final HttpHeaders headers, final HttpStatus status, final WebRequest request) {
        ...
        final ApiError apiError = new ApiError(HttpStatus.BAD_REQUEST, ex.getLocalizedMessage(), Arrays.asList(error));
